...
function (_super) {
  ...
  function DataSource(instanceSettings) {
    ...
    _this.BackendService = Object(_grafana_runtime__WEBPACK_IMPORTED_MODULE_3__["getBackendSrv"])();
    _this.Url = instanceSettings.url;
    _this.ApiKey = instanceSettings.jsonData.key;
    return _this;
  }
  ...
  DataSource.prototype.query = function (options) {
    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
      ...
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        switch (_a.label) {
          case 0:
            asyncData = options.targets.map(function (target) {
              return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(_this, void 0, void 0, function () {
                var query, appInfo, targetField, query, testInfo, targetField, screenShot, targetObject;
                return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                  switch (_a.label) {
                    case 0:
                      ...
                      if (!(target.metric === 'build')) return [3
                      /*break*/
                      , 2];
                      query = lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()(target, _types__WEBPACK_IMPORTED_MODULE_4__["defaultQuery"]);
                      return [4
                      /*yield*/
                      , this.getLatestBuilds(target.application, target.owner, target.branch)];

                    case 1:
                      appInfo = _a.sent();
                      targetField = query.filedValue;
                    ...
                    case 2:
                      if (!(target.metric === 'testRun')) return [3
                      /*break*/
                      , 6];
                      query = lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()(target, _types__WEBPACK_IMPORTED_MODULE_4__["defaultQuery"]);
                      return [4
                      /*yield*/
                      , this.getLatestTestRunByPlatform(target.application, target.owner, target.testSeriesName, target.platform)];

                    case 3:
                      testInfo = _a.sent();
                      targetField = query.filedValue;
                      screenShot = '';
                      if (!(targetField === 'image' && testInfo)) return [3
                      /*break*/
                      , 5];
                      return [4
                      /*yield*/
                      , this.getTestRunScreenShots(target.application, target.owner, testInfo.id)];
                    ...
                    case 5:
                      if (testInfo) {
                        ...
                        , new _grafana_data__WEBPACK_IMPORTED_MODULE_2__["MutableDataFrame"]({
                          ...
                          fields: [{
                            name: target.application + targetField,
                            values: [targetObject[targetField]],
                            type: _grafana_data__WEBPACK_IMPORTED_MODULE_2__["FieldType"].string
                          }]
                        })];
                      }
  ...
  DataSource.prototype.getLatestBuilds = function (appName, owner, branch) {
    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
      var url, response, branchesWithBuilds, targetRawBuild, info;
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        switch (_a.label) {
          case 0:
            url = this.Url + "/v0.1/apps/" + owner + "/" + appName + "/branches";
            return [4
            /*yield*/
            , this.doRequest(url)];
          ...
          case 1:
            response = _a.sent();
            branchesWithBuilds = response.map(function (rawBuild) {
              return {
                branch: rawBuild.branch.name,
                buildInfo: rawBuild.lastBuild
              };
            });
            targetRawBuild = branchesWithBuilds.find(function (x) {
              return x.branch === branch;
            });

            if (targetRawBuild && targetRawBuild.buildInfo) {
              info = targetRawBuild.buildInfo;
              return [2
              /*return*/
              , {
                id: info.id,
  ...
  DataSource.prototype.getLatestTestRunByPlatform = function (appName, owner, testSeries, platform) {
    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
      var url, response, testRuns, targetPlatformTestRuns;
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            url = this.Url + "/v0.1/apps/" + owner + "/" + appName + "/test_series/" + testSeries + "/test_runs";
            return [4
            /*yield*/
            , this.doRequest(url)];
          ...
          case 1:
            response = _a.sent();
            testRuns = response.map(function (rawTestRun) {
              return rawTestRun;
            });
            targetPlatformTestRuns = testRuns.filter(function (x) {
              return x.platform.toLowerCase() === platform;
            }).sort(function (prev, next) {
              return prev.date.localeCompare(next.date);
            });
            return [2
            /*return*/
            , targetPlatformTestRuns.length > 0 ? targetPlatformTestRuns[targetPlatformTestRuns.length - 1] : undefined];
        }
      });
    });
  };

  DataSource.prototype.getTestRunScreenShots = function (appName, owner, testId) {
    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
      var url, response, reportUrls, lastTestFeature, screenShotUrls, i, body;
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            url = this.Url + "/v0.1/apps/" + owner + "/" + appName + "/test_runs/" + testId + "/report";
            return [4
            /*yield*/
            , this.doRequest(url)];
          ...
          case 1:
            response = _a.sent();
            reportUrls = [];
            lastTestFeature = response.features.findIndex(function (x) {
              return x.name.toLowerCase().includes('test');
            });
            response.features[lastTestFeature].tests.forEach(function (test) {
              return test.runs.forEach(function (run) {
                return run.steps.forEach(function (step) {
          ...
          case 2:
            if (!(i < reportUrls.length)) return [3
            /*break*/
            , 5];
            return [4
            /*yield*/
            , this.doRequest(reportUrls[i])];
  ...
  DataSource.prototype.getAppList = function () {
    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
      var url, response;
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        switch (_a.label) {
          case 0:
            url = this.Url + "/v0.1/apps";
            return [4
            /*yield*/
            , this.doRequest(url)];
  ...
  DataSource.prototype.doRequest = function (url) {
    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
      ...
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [4
            /*yield*/
            , this.BackendService.datasourceRequest(options)];
  ...
  DataSource.prototype.mapStatusToBuildStates = function (status, result) {
    if (status !== 'completed') {
      return status === 'inProgress' ? _types__WEBPACK_IMPORTED_MODULE_4__["BuildStates"].PENDING : _types__WEBPACK_IMPORTED_MODULE_4__["BuildStates"].QUEUED;
    } else if (result !== null && result === 'succeeded') {
      return _types__WEBPACK_IMPORTED_MODULE_4__["BuildStates"].SUCCESS;
    } else {
      return _types__WEBPACK_IMPORTED_MODULE_4__["BuildStates"].FAILED;
    }
  };
...
function (_super) {
  ...
  function QueryEditor(props) {
    ...
    _this.onAppChange = function (event) {
      var _a = _this.props,
          onChange = _a.onChange,
          query = _a.query;
      var application = event.value;

      if (application) {
        var platform = application.internalName.toLowerCase().includes('ios') ? 'ios' : 'android';
        onChange(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, query), {
          application: application.internalName,
    ...
    _this.onMetricChange = function (event) {
      var _a = _this.props,
          onChange = _a.onChange,
          query = _a.query;
      onChange(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, query), {
        metric: event.value || 'build'
      }));
    };

    _this.onBranchChange = function (event) {
      var _a = _this.props,
          onChange = _a.onChange,
          query = _a.query;
      onChange(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, query), {
    ...
    _this.onTestSeriesChange = function (event) {
      var _a = _this.props,
          onChange = _a.onChange,
          query = _a.query;
      onChange(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, query), {
        testSeriesName: event.target.value
      }));
    };
  ...
  QueryEditor.prototype.componentDidMount = function () {
    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
      var appsFromDS, appList;
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4
            /*yield*/
            , this.props.datasource.getAppList()];

          case 1:
            appsFromDS = _a.sent();
            appList = appsFromDS.map(function (app) {
              return {
                value: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, app),
  ...
  QueryEditor.prototype.render = function () {
    ...
    var metric = query.metric,
        ...
        owner = query.owner,
        filedValue = query.filedValue,
        testSeriesName = query.testSeriesName;
    var apps = this.state.apps;
    var appsOptions = apps.length > 0 ? apps : [{
      value: undefined,
      label: 'Select App'
    }];
    var fieldOptions = metric === 'build' ? _types__WEBPACK_IMPORTED_MODULE_4__["BuildFieldOptions"] : _types__WEBPACK_IMPORTED_MODULE_4__["TestFieldOptions"];
    var metricOptions = [{
      value: 'build',
      label: 'Builds'
    }, {
    ...
    return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
      ...
      value: {
        value: metric,
        label: metricOptions.find(function (x) {
          return x.value === metric;
        }).label
      },
      options: metricOptions,
      onChange: this.onMetricChange
    }), metric === 'build' && react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["FormField"], {
      label: 'Target Branch',
      type: 'text',
    ...
    }), metric === 'testRun' && react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["FormField"], {
...
/*!******************!*\
  !*** ./types.ts ***!
  \******************/
/*! exports provided: defaultQuery, BuildFieldOptions, TestFieldOptions, BuildStates */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "defaultQuery", function() { return defaultQuery; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BuildFieldOptions", function() { return BuildFieldOptions; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TestFieldOptions", function() { return TestFieldOptions; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BuildStates", function() { return BuildStates; });
var defaultQuery = {
  metric: 'build',
  filedValue: 'status',
  branch: 'master'
